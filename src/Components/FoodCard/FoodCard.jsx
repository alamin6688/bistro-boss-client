    ...
    <div className="card bg-base-00 shadow-2xl py-8">
      ...
      <div className="card-body text-center space-y-2">
        ...
        <div className="card-actions justify-center">
          ...
          className="btn btn-outline border-0 border-b-4 text-slate-900 hover:text-yellow-400 hover:border-b-4 hover:border-yellow-400 font-bold bg-[#E8E8E8] uppercase">
                Add to cart
          </button>
        </div>
      </div>
